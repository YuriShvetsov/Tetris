...
1. Исправить ошибки
    - Ошибка заполнения карты мира, удаления заполненных строк и тд
    - Зажатие клавиши поворота
    1.3. Ошибка новой игры после проигрыша
    1.4. Протестировать, выявить возможные ошибки

2. Перейти к реализации новых компонентов и функций игры
    2.1. Сетка
    2.2. Темная тема
